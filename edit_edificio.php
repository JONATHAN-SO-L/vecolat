...
/*
		if(isset($_POST['empresa_id']) && isset($_POST['descripcion']) ){
...
include ("conexi.php");
 ...
 if(isset($_POST['descripcion']) && isset($_POST['calle']) && isset($_POST['municipio'])){ 
		...
		if(isset($_POST['requisitos_acceso'])){
			...
			if(mysqli_query($con,("UPDATE edificio set descripcion='$descripcion', calle='$calle', numero_exterior='$numero_exterior', numero_interior='$numero_interior', colonia='$colonia', municipio='$municipio', entidad_federativa='$entidad_federativa', codigo_postal='$codigo_postal', pais='$pais', direccion_gps='direccion_gps', contacto_nombre='$contacto_nombre', contacto_apellido='$contacto_apellido', contacto_puesto='$contacto_puesto', contacto_email='$contacto_email', contacto_telefono='$contacto_telefono', requisitos_acceso='$requisitos_acceso' WHERE id_edificio ='$id_edit'"))){
			...
			echo '
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        No hemos podido Actualizar el edificio
                    </p>
                </div>
            '; 
		}
	  ...
	  <fieldset>
                            ...
                            <label class="col-sm-222 control-label">ID</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input class="form-control" type="text" readonly="" name="id_edit" readonly="" value="<?php echo $reg['id_edificio']?>">
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label">Descripción</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" required="" name="descripcion" maxlength="30" value="<?php echo utf8_decode($reg['descripcion'])?>">
                                <span class="input-group-addon"><i class="fa fa-eye"></i></span>
                              </div>
                          </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label">Nombre del Contacto</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" name="contacto_nombre" maxlength="30" value="<?php echo utf8_decode($reg['contacto_nombre'])?>">
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label">Apellido del Contacto</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" name="contacto_apellido" maxlength="30" value="<?php echo utf8_decode( $reg['contacto_apellido'])?>">
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label">Puesto del Contacto</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" name="contacto_puesto" maxlength="30" value="<?php echo utf8_decode($reg['contacto_puesto'])?>">
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label">Email del Contacto</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="email" class="form-control" name="contacto_email" value="<?php echo utf8_decode($reg['contacto_email'])?>">
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label">Telefono del Contacto</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" name="contacto_telefono" maxlength="50" value="<?php echo utf8_decode($reg['contacto_telefono'])?>">
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
