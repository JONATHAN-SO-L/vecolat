		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Mantenimientos Programados Oficina</h1>
...
<div class="buscar_index" >	
	...
	$consulta = "SELECT * from sop_preventivo Where ubicacion='Oficinas' AND estado_ticket='Programado' ";
	$resultado = mysqli_query( $conexion, $consulta) or die ( "Algo ha ido mal en la consulta a la base de datos");

ECHO "<table class='table table-hover table-striped table-bordered'><th>Acción</th><th>Id</th><th>Fecha</th><th>Serie</th><th>Fecha Programada</th><th>Estado</th><th>Usuario</th><th>Email</th><th>Asesor Técnico</th>";
