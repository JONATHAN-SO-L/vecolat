...
<section id="content">
 ...
 <table>
		   <a href="inicio_user.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center">&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
    ...
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form role="form" action="seccion_consul2_user.php" method="POST">
			
						
						<!--/////////////////////////////////////////////////////////////////////////////////////////////////////-->
						<div><label><i class="fa fa-hospital-o"></i>&nbsp;Equipo</label>
						<select class="form-control" name="equipo" id="equipo">
				<option class="form-control" value="">Seleccionar Equipo</option>
				<?php
