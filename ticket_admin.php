...
<section id="content">
  ...
  <table>
		    <a href="ticket_add_admin.php" ><button type="submit" value="Adicionar" name="" class="btn btn-primary" style="text-align:center"><i class="fa fa-plus"></i>&nbsp;&nbsp;Adicionar</button></a>
			<td>
 <tr>
		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Administracion de Administradores</h1>
...
<div class="buscar_index" style="width: 1030px;">	
	...
	$consulta = "SELECT * from admin_soporte ";
	$resultado = mysqli_query( $conexion, $consulta) or die ( "Algo ha ido mal en la consulta a la base de datos");



ECHO "<table class='table table-hover table-striped table-bordered'><th>Acción</th><th>ID</th><th>Admin</th><th>Nombre</th><th>Apellido</th><th>Email</th>";
	...
	echo "<tr>";
      ?>
		<td class="text-center">
					...
					<a href="ticket_eli_admin.php?id=<?php echo $fila['id']; ?>"class="btn btn-sm btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
        </td>
        <?php
		...
		ECHO " <TD>".utf8_decode($fila["email_admin"])."</TD>";
