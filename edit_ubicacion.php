          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Editar Ubicación</h1>
...
if(isset($_POST['rfc']) && isset($_POST['razon_social']) && isset($_POST['nombre_corto'])){
 ...
 if(isset($_POST['requisitos_acceso']) && isset($_POST['ubicacion'])){ 
		...
		*/
		...
		if(isset($_POST['requisitos_acceso'])){
			...
			if(mysqli_query($con,("UPDATE ubicacion set ubicacion='$descripcion', requisitos_acc='$requisitos_acceso' WHERE id_ubicacion='$id_edit'"))){
			...
			echo '
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        No hemos podido Actualizar la información
                    </p>
                </div>
            '; 
		}
