	...
	if(isset($_POST['calle']) && isset($_POST['descripcion'])){
          ...
          if(mysqli_num_rows($sql)>=1){
			 ...
			 '<script language="javascript">
				alert("Edificio Eliminada");
				window.location.href="edificio.php"</script>';
          }else{
            echo'
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    <a href="edificio.php"><button type="button" class="close"  data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h4 class="text-center">OCURRIÓ UN ERROR</h4>
                    <p class="text-center">
                        No hemos podido eliminar el registro por que los datos son incorrectos
                    </p>
                </div>
            '; 
          }
                            ...
                            <label class="col-sm-222 control-label">ID</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" readonly="" name="id_edit" readonly="" value="<?php echo $reg['id_edificio']?>">
