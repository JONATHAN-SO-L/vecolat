		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Tickets Reparaci&#243;n en Garantia</h1>
...
<a class="boton_personalizado" href="ticket_admin_resuelto.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_admin_resuelto.php">&nbsp;&nbsp;&nbsp;&nbsp;Resueltos</a></strong>
  ...
  <div class="buscar_index">	
	...
	$consulta = "SELECT * from ticket where estado_ticket='Reparacion en Garantia' AND ubicacion='Oficinas' ";
	$resultado = mysqli_query( $conexion, $consulta) or die ( "Algo ha ido mal en la consulta a la base de datos");


ECHO "<table class='table table-hover table-striped table-bordered'><th>Acción</th><th>ID</th><th>Fecha</th><th>Serie</th><th>Usuario</th><th>Estado</th>";
