     ...
     function footer(){
    	$this->SetY(200);
			...
			$this->Cell(0,10,'Page '.$this->PageNo().'/{nb}',0,0,'C');
				$this->SetXY(240,200);
					$this->Cell (30,10, 'Rev. 6;09/21 FV-05-7-002' ,0,0,'C');
     }
}
...
*/
	...
	$consulta = "SELECT * FROM `equipo_usuario` WHERE ubicacion = 'Oficinas' AND equipo != 'Celular' ORDER BY num_serie,area ASC";
    ...
    $pdf->Cell (20,7,utf8_decode($row['equipo']),1,0,'C');
    ...
    $pdf->Cell (40,7,utf8_decode($row['procesador']),1,0,'C');
