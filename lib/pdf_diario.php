...
$equipo=MysqlQuery::RequestPost('equipo');
    $semana=MysqlQuery::RequestPost('semana');
	$sql = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' OR dia = 'Monday' ");
	$dat=mysqli_fetch_array($sql, MYSQLI_ASSOC);
...
$equipo=MysqlQuery::RequestPost('equipo');
    $semana=MysqlQuery::RequestPost('semana');
	$sqlw = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' OR dia = 'Tuesday'");
	$datm=mysqli_fetch_array($sqlw, MYSQLI_ASSOC);
		...
		$equipo=MysqlQuery::RequestPost('equipo');
    $semana=MysqlQuery::RequestPost('semana');
	$sqlw = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' OR dia = 'Wednesday'");
	$datw=mysqli_fetch_array($sqlw, MYSQLI_ASSOC);
...
$equipo=MysqlQuery::RequestPost('equipo');
    $semana=MysqlQuery::RequestPost('semana');
	$sqlj = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' OR dia = 'Thursday'");
	$datj=mysqli_fetch_array($sqlj, MYSQLI_ASSOC);
	...
	$equipo=MysqlQuery::RequestPost('equipo');
    $semana=MysqlQuery::RequestPost('semana');
	$sqlv = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' OR dia = 'Friday'");
	$datv=mysqli_fetch_array($sqlv, MYSQLI_ASSOC);
		...
		$equipo=MysqlQuery::RequestPost('equipo');
    $semana=MysqlQuery::RequestPost('semana');
	$sqls = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' OR dia = 'Saturday'");
	$dats=mysqli_fetch_array($sqls, MYSQLI_ASSOC);
		...
		$equipo=MysqlQuery::RequestPost('equipo');
    $semana=MysqlQuery::RequestPost('semana');
	$sqld = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' OR dia = 'Sunday'");
	$datd=mysqli_fetch_array($sqld, MYSQLI_ASSOC);	
