...
include './config.php';
	...
	$equipo= $_REQUEST['equipo_id'];
	$fecha = $_REQUEST['fecha_i'];
...
$pdf->Cell (190,35,'',1,1,'C');
	...
	$sqlm = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' AND dia = 'Tuesday' "); 
	$datm = mysqli_fetch_array($sqlm, MYSQLI_ASSOC);

	$sqls = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' AND dia = 'Wednesday' "); 
	...
	$sqlw = Mysql::consulta("SELECT * FROM diario_serv WHERE equipo = '$equipo' AND semana = '$semana' AND dia = 'Saturday' "); 
	...
	$datd = mysqli_fetch_array($sqld, MYSQLI_ASSOC);
		...
		$pdf->SetXY(106,60);
		$pdf->Cell (20,4,$dats['fecha_servicio'],1,1,'C');
		$pdf->SetXY(106,64);
		$pdf->Cell (20,4,$dats['tecnico'],1,1,'C');
		$pdf->SetXY(106,68);
		$pdf->Cell (20,4,$dats['hora'],1,1,'C');
		$pdf->SetXY(106,72);
		$pdf->Cell (20,4,$dats['frecuencia'],1,1,'C');
		$pdf->SetXY(106,76);
		$pdf->Cell (20,4,$dats['potencia'],1,1,'C');
		$pdf->SetXY(106,80);
		$pdf->Cell (20,4,$dats['vel_moto'],1,1,'C');
		$pdf->SetXY(106,84);
		$pdf->Cell (20,4,$dats['operacion'],1,1,'C');
		$pdf->SetXY(106,88);
		$pdf->Cell (20,4,$dats['amperaje'],1,1,'C');
		$pdf->SetXY(106,92);
		$pdf->Cell (20,4,$dats['caida_merv8'],1,1,'C');
		$pdf->SetXY(106,96);
		$pdf->Cell (20,4,$dats['car_act'],1,1,'C');
		$pdf->SetXY(106,100);
		$pdf->Cell (20,4,$dats['caida_merv15'],1,1,'C');
		$pdf->SetXY(106,104);
		$pdf->Cell (20,4,$dats['caida_merv17'],1,1,'C');
		$pdf->SetXY(106,108);
		$pdf->Cell (20,4,$dats['l1'],1,1,'C');
		$pdf->SetXY(106,112);
		$pdf->Cell (20,4,$dats['l2'],1,1,'C');
		$pdf->SetXY(106,116);
		$pdf->Cell (20,4,$dats['l3'],1,1,'C');
		$pdf->SetXY(106,120);
		$pdf->Cell (20,4,$dats['l1_l2'],1,1,'C');
		$pdf->SetXY(106,124);
		$pdf->Cell (20,4,$dats['l1_l3'],1,1,'C');
		$pdf->SetXY(106,128);
		$pdf->Cell (20,4,$dats['l2_l3'],1,1,'C');
		$pdf->SetXY(106,132);
		$pdf->Cell (20,4,$dats['neutro'],1,1,'C');
		$pdf->SetXY(106,136);
		$pdf->Cell (20,4,$dats['aah_temp'],1,1,'C');
		$pdf->SetXY(106,140);
		$pdf->Cell (20,4,$dats['aah_psi'],1,1,'C');
		$pdf->SetXY(106,144);
		$pdf->Cell (20,4,$dats['rah_temp'],1,1,'C');
		$pdf->SetXY(106,148);
		$pdf->Cell (20,4,$dats['rah_psi'],1,1,'C');
		$pdf->SetXY(106,152);
		$pdf->Cell (20,4,$dats['aac_temp'],1,1,'C');
		$pdf->SetXY(106,156);
		$pdf->Cell (20,4,$dats['aac_psi'],1,1,'C');
		$pdf->SetXY(106,160);
		$pdf->Cell (20,4,$dats['rac_temp'],1,1,'C');
		$pdf->SetXY(106,164);
		$pdf->Cell (20,4,$dats['rac_psi'],1,1,'C');
		$pdf->SetXY(106,168);
		$pdf->Cell (20,4,$dats['manometro'],1,1,'C');
		$pdf->SetXY(106,172);
		$pdf->Cell (20,4,$dats['manguera'],1,1,'C');
		$pdf->SetXY(106,176);
		$pdf->Cell (20,4,$dats['filtro'],1,1,'C');
		$pdf->SetXY(106,180);
		$pdf->Cell (20,4,$dats['drenajes'],1,1,'C');
		...
		$pdf->SetXY(166,60);
		$pdf->Cell (19,4,$datw['fecha_servicio'],1,1,'C');
		$pdf->SetXY(166,64);
		$pdf->Cell (19,4,$datw['tecnico'],1,1,'C');
		$pdf->SetXY(166,68);
		$pdf->Cell (19,4,$datw['hora'],1,1,'C');
		$pdf->SetXY(166,72);
		$pdf->Cell (19,4,$datw['frecuencia'],1,1,'C');
		$pdf->SetXY(166,76);
		$pdf->Cell (19,4,$datw['potencia'],1,1,'C');
		$pdf->SetXY(166,80);
		$pdf->Cell (19,4,$datw['vel_moto'],1,1,'C');
		$pdf->SetXY(166,84);
		$pdf->Cell (19,4,$datw['operacion'],1,1,'C');
		$pdf->SetXY(166,88);
		$pdf->Cell (19,4,$datw['amperaje'],1,1,'C');
		$pdf->SetXY(166,92);
		$pdf->Cell (19,4,$datw['caida_merv8'],1,1,'C');
		$pdf->SetXY(166,96);
		$pdf->Cell (19,4,$datw['car_act'],1,1,'C');
		$pdf->SetXY(166,100);
		$pdf->Cell (19,4,$datw['caida_merv15'],1,1,'C');
		$pdf->SetXY(166,104);
		$pdf->Cell (19,4,$datw['caida_merv17'],1,1,'C');
		$pdf->SetXY(166,108);
		$pdf->Cell (19,4,$datw['l1'],1,1,'C');
		$pdf->SetXY(166,112);
		$pdf->Cell (19,4,$datw['l2'],1,1,'C');
		$pdf->SetXY(166,116);
		$pdf->Cell (19,4,$datw['l3'],1,1,'C');
		$pdf->SetXY(166,120);
		$pdf->Cell (19,4,$datw['l1_l2'],1,1,'C');
		$pdf->SetXY(166,124);
		$pdf->Cell (19,4,$datw['l1_l3'],1,1,'C');
		$pdf->SetXY(166,128);
		$pdf->Cell (19,4,$datw['l2_l3'],1,1,'C');
		$pdf->SetXY(166,132);
		$pdf->Cell (19,4,$datw['neutro'],1,1,'C');
		$pdf->SetXY(166,136);
		$pdf->Cell (19,4,$datw['aah_temp'],1,1,'C');
		$pdf->SetXY(166,140);
		$pdf->Cell (19,4,$datw['aah_psi'],1,1,'C');
		$pdf->SetXY(166,144);
		$pdf->Cell (19,4,$datw['rah_temp'],1,1,'C');
		$pdf->SetXY(166,148);
		$pdf->Cell (19,4,$datw['rah_psi'],1,1,'C');
		$pdf->SetXY(166,152);
		$pdf->Cell (19,4,$datw['aac_temp'],1,1,'C');
		$pdf->SetXY(166,156);
		$pdf->Cell (19,4,$datw['aac_psi'],1,1,'C');
		$pdf->SetXY(166,160);
		$pdf->Cell (19,4,$datw['rac_temp'],1,1,'C');
		$pdf->SetXY(166,164);
		$pdf->Cell (19,4,$datw['rac_psi'],1,1,'C');
		$pdf->SetXY(166,168);
		$pdf->Cell (19,4,$datw['manometro'],1,1,'C');
		$pdf->SetXY(166,172);
		$pdf->Cell (19,4,$datw['manguera'],1,1,'C');
		$pdf->SetXY(166,176);
		$pdf->Cell (19,4,$datw['filtro'],1,1,'C');
		$pdf->SetXY(166,180);
		$pdf->Cell (19,4,$datw['drenajes'],1,1,'C');
