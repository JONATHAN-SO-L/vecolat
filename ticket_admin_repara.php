		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Tickets en Requisición de compra</h1>
...
<a class="boton_personalizado" href="ticket_admin_resuelto.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_admin_resuelto.php">&nbsp;&nbsp;&nbsp;&nbsp;Resueltos</a></strong>
        ...
        <br><br>
  <table>
		    <!--a href="soporte.php" ><button type="submit" value="Adicionar" name="" class="btn btn-primary" style="text-align:center"><i class="fa fa-plus"></i>&nbsp;&nbsp;Adicionar</button></a-->
			<td>
 <!--tr>
...
<div class="buscar_index" >	
	...
	$consulta = "SELECT * from ticket where estado_ticket='Requisicion' AND ubicacion='$ubicacion' ";
