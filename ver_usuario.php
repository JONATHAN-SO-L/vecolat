          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Ver Usuario </h1>
...
$id = MysqlQuery::RequestGet('id');
	$sql = Mysql::consulta("SELECT * FROM usuario inner join empresas on usuario.empresa_id=empresas.id WHERE id_usuario= '$id'");
	  ...
	  <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-222 control-label">Empresa</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" readonly="" class="form-control" readonly="" name="empresa_id" readonly="" value="<?php echo utf8_decode($reg['nombre_corto'])?>">
                                <span class="input-group-addon"><i class="fa fa-eye"></i></span>
                              </div>
                          </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label">Razon Social</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text"  readonly="" class="form-control"  placeholder="Razon Social" name="razon_social" readonly="" value="<?php echo utf8_decode($reg['razon_social'])?>">
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" readonly="" type="email" placeholder="Escriba su Correo" name="email_cliente" readonly="" value="<?php echo utf8_decode($reg['email_cliente'])?>">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
