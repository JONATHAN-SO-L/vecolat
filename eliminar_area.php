          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Borrar Área</h1>
...
if(isset($_POST['area']) && isset($_POST['prioridad'])){
		$id_edit=MysqlQuery::RequestPost('id_edit');
		$descripcion=  MysqlQuery::RequestPost('area');
		$prioridad=  MysqlQuery::RequestPost('prioridad');

	if(isset($_POST['area']) && isset($_POST['prioridad'])){
          $empresa_delete=MysqlQuery::RequestPost('area');
          $corto_delete=MysqlQuery::RequestPost('prioridad');
         
          $sql=Mysql::consulta("SELECT * FROM area WHERE area= '$empresa_delete' AND prioridad='$corto_delete'");

          if(mysqli_num_rows($sql)>=1){
             MysqlQuery::Eliminar("area", "area='$empresa_delete' and prioridad='$corto_delete'");
            ...
            echo'
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        No hemos podido eliminar el área por que los datos han sido ocupados por otras bases.
                    </p>
                </div>
            '; 
          }
...
?>
	  ...
	  <fieldset>
                		<input type="hidden" name="id_edit" value="<?php echo $reg['id_area']?>">
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" readonly="" type="text" placeholder="Descripción" name="area" value="<?php echo utf8_decode($reg['area'])?>">
								   <span class="input-group-addon"><i class="fa fa-eye"></i></span>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                    <input class="form-control" readonly="" name="prioridad" value="<?php echo utf8_decode($reg['prioridad'])?>">
									  <span class="input-group-addon"><i class="fa fa-eye"></i></span>
                                </div>
                            </div>
                        </div>
