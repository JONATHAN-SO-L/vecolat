...
<section id="content">	 
  ...
  <table>
		    <a href="seccion3.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center">&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
...
<!--//////////////////-->
  ...
  <div class="row">
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form  method="POST" action="seccion4.php"  enctype="multipart/form-data">
						
                        
						
						<input type="hidden" readonly="" name="fecha_servicio" readonly="" value="<?php echo date("Y-m-d");?>">
						...
						<div class="form-group">
                          <center><label  align="center" class="col-sm-222 control-label">Fecha   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hora</label></center>
						  <div class="col-sm-110">
						    <center><font size=4 color="blue" class="col-sm-222 control-label"><?php echo date("Y-m-d");?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  <font size=4 color="blue" class="col-sm-222 control-label"><?php echo strftime("%H:%M");?></font></center>
                          </div>
                        </div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor1" required="" value="" maxlength="80">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor2" required="" value="" maxlength="80">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
    ...
    ?>
	        ...
	        <input type="hidden" class="form-control" readonly="" name="area" value="<?php echo utf8_decode($medidas['area'])?>">
<?php
		}
	?>		
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor1_s2" required="" value="" maxlength="80">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>						
				...
				<div class="form-group">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" required="" name="valor2_s2" value="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" required="" name="valor1_s3" value="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
                ...
                <br>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor2_s3" required="" value="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
              ...
              <div class="col-sm-2">
                  <input type="text" class="form-control" name="amperaje1_s3" required="" maxlength="40">
              </div>
                        <font size=3 color="blue" FACE="arial"  class="col-sm-2 control-label">L2-L3</font>
              <div class="col-sm-2">
                  <input type="text" class="form-control" name="amperaje2_s3" required="" maxlength="40">
              </div>
                        <font size=3 color="blue" FACE="arial"  class="col-sm-2 control-label">L3-L1</font>
              <div class="col-sm-2">
                  <input type="text" class="form-control" name="amperaje3_s3" required="" maxlength="40">
              </div>
              </div>
              <br>
						<div class="form-group">
			  ...
			  <br>
                        <font size=3 color="blue" FACE="arial"  class="col-sm-2 control-label">L1-L2</font>
              <div class="col-sm-2">
                  <input type="text" class="form-control" name="amperaje4_s3" required="" maxlength="40">
              </div>
                        <font size=3 color="blue" FACE="arial"  class="col-sm-2 control-label">L2-L3</font>
              <div class="col-sm-2">
                  <input type="text" class="form-control" name="amperaje5_s3" required="" maxlength="40">
              </div>
                        <font size=3 color="blue" FACE="arial"  class="col-sm-2 control-label">L3-L1</font>
              <div class="col-sm-2">
                  <input type="text" class="form-control" name="amperaje6_s3" required="" maxlength="40">
              </div>
              </div>              
						<br>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor1_s4" value="" required="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor2_s4" value="" required="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>						
              ...
              <br>                        
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor1_s5" value="" required="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor2_s5" value="" required="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="number" step="any" class="form-control" name="valor3_s5" value="" required="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="text" class="form-control" name="valor_uptime" value="" required="">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
              ...
              <div class="col-sm-2">
                  <input type="text" class="form-control" required="" name="tempentrada" maxlength="10">
              </div>
			  <label  class="col-sm-2 control-label">Salida: </label>
              <div class="col-sm-2">
                  <input type="text" class="form-control" required="" name="tempsalida" maxlength="10">
              </div>
			...
			<div class="form-group">
              ...
              <div class="col-sm-2">
			  <div class="input-group">
                  <input type="text" class="form-control" required="" name="tempresion" maxlength="10">
              </div>
			  </div>
            </div>
            </div>
			...
			<div class="form-group">
			  ...
			  <label  class="col-sm-2 control-label">Entrada</label>
              <div class="col-sm-2">
                  <input type="text" class="form-control" required="" name="tempentrada2" maxlength="10">
              </div>
			  <label  class="col-sm-2 control-label">Salida</label>
              <div class="col-sm-2">
                  <input type="text" class="form-control"  required="" name="tempsalida2" maxlength="10">
              </div>
            </div>
			...
			<div class="form-group">
              ...
              <div class="col-sm-2">
			  <div class="input-group">
                  <input type="text" class="form-control"  required="" name="tempresion2" maxlength="10">
              </div>
			  </div>
            </div>
