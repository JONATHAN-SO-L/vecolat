...
<section id="content">
  ...
  <table>
   <a href="add_empresa2.php" ><button type="submit" value="Adicionar" name="" class="btn btn-primary" style="text-align:center"><i class="fa fa-plus"></i>&nbsp;&nbsp;Adicionar</button></a>
			<td>
 <tr>
...
ECHO "<table class='table table-hover table-striped table-bordered'><th>Acción</th><th>Id</th><th>RFC</th><th>Razón Social</th><th>Nombre Corto</th><th>Calle</th><th>Número Ex</th><th>Número Int</th><th>Colonia</th><th>Municipio</th><th>Entidad</th><th>Codigo Postal</th><th>País</th><th>Dirección GPS</th><th>Nombre de Contacto</th><th>Apellido de Contacto</th><th>Puesto de Contacto</th><th>Email de Contacto</th><th>Telefono de Contacto</th>";
