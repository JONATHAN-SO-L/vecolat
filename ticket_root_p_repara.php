		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Tickets Requisici&#243;n de Compra Planta</h1>
...
<a class="boton_personalizado" href="ticket_root_oficinas.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_root_oficinas.php">&nbsp;&nbsp;&nbsp;&nbsp;Oficinas</a></strong>
        ...
        <br>
          ...
          <div class="row">
            <div class="col-sm-12">
           <div class="page-header2">
<a class="boton_personalizado" href="ticket_root_p_pendiente.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_root_p_pendiente.php">&nbsp;&nbsp;&nbsp;&nbsp;Pendientes </a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_root_p_proceso.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_root_p_proceso.php">&nbsp;&nbsp;&nbsp;&nbsp;Proceso</a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_root_p_repara.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_root_p_repara.php">&nbsp;&nbsp;&nbsp;&nbsp;Requisici&#243;n de Compra</a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_root_p_resuelto.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_root_p_resuelto.php">&nbsp;&nbsp;&nbsp;&nbsp;Resueltos</a></strong>
				</div>
            </div>
          </div>
        </div>
...
<div class="buscar_index">	
	...
	$consulta = "SELECT * from ticket where estado_ticket='Requisicion' AND ubicacion='Planta' ";
