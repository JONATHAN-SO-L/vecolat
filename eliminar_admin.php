          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Borrar Administrador</h1>
...
if(isset($_POST['nombre_admin']) && isset($_POST['clave']) && isset($_POST['nombre'])){
	...
	if(isset($_POST['nombre_admin']) && isset($_POST['nombre'])){
          ...
          $sql=Mysql::consulta("SELECT * FROM administrador WHERE nombre_admin= '$empresa_delete' AND nombre='$corto_delete'");

          if(mysqli_num_rows($sql)>=1){
             MysqlQuery::Eliminar("administrador", "nombre_admin='$empresa_delete' and nombre='$corto_delete'");
			 
			 echo 
			 '<script language="javascript">
				alert("Usuario Eliminado");
				window.location.href="tabla_admin.php"</script>';
          }else{
            echo'
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    <a href="tabla_admin.php"><button type="button" class="close"  data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
...
?>
	  ...
	  <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" readonly="" placeholder="Nombre de Usuario" type="text" name="nombre_admin" readonly="" value="<?php echo utf8_decode($reg['nombre_admin'])?>">
