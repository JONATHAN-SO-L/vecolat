          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Entrada Comida</h1>
...
if(isset($_POST['name_usuario']) && isset($_POST['fecha_checador'])){ 
			...
			$entrada_comer= $_POST['entrada_comer'];
			
			$con=mysqli_connect($host,$user,$pw,$db);
			if(mysqli_query($con,("UPDATE reg_checador2 set entrada_comer='$entrada_comer' WHERE usuario='$nombre' AND fecha='$fecha' "))){
			
			echo  '<script language="javascript">
				alert("Se ha checado su regreso de la comida. Gracias");
				window.location.href="./soporte.php?view=Ccomida"</script>';
		}else{
			echo '<script language="javascript">
				alert("Su checada fue incorrecta favor de intentarlo. Gracias");
				window.location.href="./soporte.php?view=Ecomida"</script>';
		}
	}
?>	
<div class="container">
                      ...
                      <div class="form-group">
                            ...
                            <div class='col-sm-10'>
                                <div class="input-group">
                                    <input class="form-control" type="text" name="entrada_comer"  readonly value="<?php echo date("h:i A");?>">
