...
<div class="container">
        ...
        <div class="container">
          <div class="row">
            ...
            <div>
        <form method = "POST" action = "./root/list_user.php">
            <input type = "submit" value = "Listado de usuarios registrados" id = "usuarios" name = "usuarios">
        </form>
        </div>
          </div>
        </div>
                    ...
                    <div class="col-md-12">
                                ...
                                <tbody>
									...
									<td class="text-center">
                                            <form action="" method="POST" style="display: inline-block;">
                                                <a href="root.php?view=useredit&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                <a href="root.php?view=userpass&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success" ><i class="fa fa-cogs" aria-hidden="true"></i></a>
                                                <a href="root.php?view=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            </form>
                                        </td>
                                        ...
                                        <td class="text-center"><?php echo $row['tipo_usuario']; ?></td>
                                    </tr>
                                    <?php
                                        $ct++;
                                        endwhile; 
                        ...
                        <nav aria-label="Page navigation" class="text-center">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./root.php?view=users&pagina=<?php echo $pagina-1; ?>" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php
                                    for($i=1; $i <= $numeropaginas; $i++ ){
                                        if($pagina == $i){
                                            echo '<li class="active"><a href="./root.php?view=users&pagina='.$i.'">'.$i.'</a></li>';
                                        }else{
                                            echo '<li><a href="./root.php?view=users&pagina='.$i.'">'.$i.'</a></li>';
                                        }
                                    }
                                ?>
