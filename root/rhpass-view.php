...
<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="superoot"){ 
         ...
         if(isset($_POST['email_usuario']) && isset($_POST['nombre_comp'])){
            ...
            $sql=Mysql::consulta("SELECT * FROM usuario_rh WHERE nombre_comp= '$usuario' AND email_usuario='$email_reg'");
            if(mysqli_num_rows($sql)>=1){
                if(MysqlQuery::Actualizar("usuario_rh", "clave='$pass_admin_update' ", "nombre_comp='$usuario' and email_usuario='$email_reg'")){
