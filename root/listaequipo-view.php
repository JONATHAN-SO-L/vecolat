...
<div class="container">
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Equipos de Oficinas</h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido <strong><?php echo $_SESSION['nombre_completo']; ?></strong>, en esta página se muestran todos los equipos de Oficinas.</p>
            </div>
            <div>
        <form method = "POST" action = "./root/listado_of.php">
            <input type = "submit" value = "Listado de equipos en Oficinas" id = "equipos" name = "equipos" target="_blank">
        </form>
        </div>
          </div>
        </div>
                    ...
                    <div class="col-md-12">
                                ...
                                <tbody>
									...
									<td class="text-center">
                                            <form action="" method="POST" style="display: inline-block;">
                                                <a href="root.php?view=editequipo&id=<?php echo $row['id_eq_us']; ?>" class="btn btn-sm btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                        ...
                        <nav aria-label="Page navigation" class="text-center">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./root.php?view=listaequipo&pagina=<?php echo $pagina-1; ?>" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php
                                    for($i=1; $i <= $numeropaginas; $i++ ){
                                        if($pagina == $i){
                                            echo '<li class="active"><a href="./root.php?view=listaequipo&pagina='.$i.'">'.$i.'</a></li>';
                                        }else{
                                            echo '<li><a href="./root.php?view=listaequipo&pagina='.$i.'">'.$i.'</a></li>';
                                        }
                                    }
                                ?>
