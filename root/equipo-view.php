...
<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="superoot" ){ ?>
  ...
  <div class="col-sm-9">
  <a href="./lib/pdf_equipo_civac.php" class="btn btn-sm btn-success btn-sm pull-right"  target="_blank"><i class="fa fa-file-pdf-o" ></i>&nbsp;&nbsp;PDF Planta</a>
  ...
  <?php foreach($result as $row){ ?> 
    ...
    <option value="Distribucion GNU/Linux">GNU/Linux</option>
