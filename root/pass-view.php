...
<div class="container">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-9">
              <p class="lead text-info">Bienvenido <strong><?php echo $_SESSION['nombre_completo']; ?></strong>, aqui podra actualizar la contraseña de cualquier usuario si lo desea.</p>
            </div>
          </div><!--fin row-->
