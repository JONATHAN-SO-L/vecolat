...
<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="superoot"){ 
     include ("conexi.php");
		...
		if(isset($_POST['telefono'])){
			...
			if(mysqli_query($con,("UPDATE usuario_rh set nombre_usuario='$nombre_usuario', nombre_comp='$nombre_comp', email_usuario='$email_usuario', area='$area', ubicacion='$ubicacion', telefono='$telefono'
			WHERE id ='$id_edit' "))){
