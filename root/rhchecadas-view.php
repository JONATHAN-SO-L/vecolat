...
<div class="container">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido Superoot, en esta página se muestran todos los registros de checadas en el Sistema.</p>
            </div>
          
          <div class="col-sm-9">
                 <a href="./root.php?view=reporte" class="btn btn-info btn-sm pull-right"><i class="fa fa-file-excel-o" ></i>&nbsp;&nbsp;Extraer Excel</a>
            </div>
        </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <?php 
                                ...
                                $selusers=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM reg_checador2 WHERE ubicacion = 'Oficinas' LIMIT $inicio, $regpagina");
                        ...
                        <nav aria-label="Page navigation" class="text-center">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./root.php?view=rhchecadas&pagina=<?php echo $ticketselected; ?>&pagina=<?php echo $pagina-1; ?>" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php
                                    for($i=1; $i <= $numeropaginas; $i++ ){
                                        if($pagina == $i){
                                            echo '<li class="active"><a href="./root.php?view=rhchecadas&pagina='.$ticketselected.'&pagina='.$i.'">'.$i.'</a></li>';
                                        }else{
                                            echo '<li><a href="./root.php?view=rhchecadas&pagina='.$ticketselected.'&pagina='.$i.'">'.$i.'</a></li>';
                                        }
                                    }
                                ?>
