...
<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="superoot"){ ?>    
        <?php
            ...
            $num_total_rh = mysqli_num_rows($num_rh);
...
<div class="container">
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Administradores</h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido <strong><?php echo $_SESSION['nombre_completo']; ?></strong>, en esta página se muestran todos los administradores registrados en el Sistema.</p>
            </div>
            <div>
        <form method = "POST" action = "./root/listado_sop.php">
            <input type = "submit" value = "Listado de Técnicos registrados" id = "tecnicos" name = "tecnicos">
        </form>
        </div>
          </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <?php 
                                ...
                                $seladmin=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM admin_soporte WHERE id!='1' AND id!='$idA' LIMIT $inicio, $regpagina");
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Nombre Admin</th>
                                ...
                                <tbody>
									...
									<td class="text-center">
                                            <form action="" method="POST" style="display: inline-block;">
                                                <a href="root.php?view=adminedit&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <a href="root.php?view=adminpass&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success" ><i class="fa fa-cogs" aria-hidden="true"></i></a>
                                                <a href="root.php?view=deleteadm&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            </form>
                                        </td>
                        ...
                        <nav aria-label="Page navigation" class="text-center">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./root.php?view=admin&pagina=<?php echo $pagina-1; ?>" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php
                                    for($i=1; $i <= $numeropaginas; $i++ ){
                                        if($pagina == $i){
                                            echo '<li class="active"><a href="./root.php?view=admin&pagina='.$i.'">'.$i.'</a></li>';
                                        }else{
                                            echo '<li><a href="./root.php?view=admin&pagina='.$i.'">'.$i.'</a></li>';
                                        }
                                    }
                                ?>
