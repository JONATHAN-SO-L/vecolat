...
<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="superoot"){ 
    ...
    $fecha_mod = date("Y-m-d H:i:s");
			...
			if(mysqli_query($con,("UPDATE admin_soporte set nombre_admin='$nombre_admin', nombre='$nombre',/*apellido='$apellido',*/ email_admin='$email_admin', ubicacion='$ubicacion', telefono='$telefono', tecnico='$tecnico', fecha_mod='$fecha_mod'
			WHERE id ='$id_edit' "))){
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Actualización de datos del usuario Soporte</h1>
            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                  <input type="text" class="form-control"  name="nombre_admin"  value="<?php echo $reg['nombre_admin']?>">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                  <input type="email" class="form-control"  name="email_admin" value="<?php echo utf8_decode($reg['email_admin'])?>">
