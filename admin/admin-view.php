...
<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        <?php
            if(isset($_POST['id_del'])){
                ...
                if(MysqlQuery::Eliminar("admin_soporte", "id='$id_admin'")){
                    echo '
...
<div class="container">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, en esta página se muestran todos los administradores registrados en el Sistema.</p>
            </div>
          </div>
        </div>
