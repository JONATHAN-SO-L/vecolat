...
<section id="content">	 
  ...
  <table>
		    <a href="consul_diario.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center"></i>&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
	...
	echo "<tr>";
      ?>
		<td class="text-center">
			<button id="save" class="btn btn-success" data-id="<?php echo $fila['id_diario']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;PDF</button>
			<!--a href="servicios.php?id=<?php echo $fila['id_diario']; ?>" class="btn btn-info" ><i class="fa fa-eye" aria-hidden="true"> Subir Doc</i></a-->
			<?php
		...
		ECHO " <TD>".utf8_decode($fila["carpeta"])."</TD>";
