...
<section id="content">	 
  ...
  <table>
		    <a href="diario_servic.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center"></i>&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
...
$consulta = "SELECT * from diario_serv";
	$resultado = mysqli_query( $conexion, $consulta) or die ( "Algo ha ido mal en la consulta a la base de datos");



ECHO "<table class='table table-hover table-striped table-bordered'><th>Acción</th><th>Equipo</th><th>Fecha de Servicio</th><th>Hora</th><th>Semana</th><th>Tecnico</th>";
while ($fila = mysqli_fetch_array( $resultado )){
	echo "<tr>";
      ?>
		<td class="text-center">
			<a href="edit_diario.php?id=<?php echo $fila['id_diario']; ?>" class="btn btn-sm btn-success" title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>
			<a href="eliminar_diario.php?id=<?php echo $fila['id_diario']; ?>"class="btn btn-sm btn-danger" title="Borrar"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
		...
		ECHO " <TD>".utf8_decode($fila["semana"])."</TD>";
...
<script>
  $(document).ready(function(){
    $("button#save").click(function (){
       window.open ("./lib/pdf_diario.php?id="+$(this).attr("data-id"));
    });
  });
</script>
<footer></footer>
