		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Mantenimientos Resueltos Oficina</h1>
...
<a class="boton_personalizado" href="ticket_mant_o_prog.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_mant_o_prog.php">&nbsp;&nbsp;&nbsp;&nbsp;Oficina</a></strong>
        ...
        <br>
          ...
          <div class="row">
            <div class="col-sm-12">
           <div class="page-header2">
<a class="boton_personalizado" href="ticket_mant_o_prog.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_mant_o_prog.php">&nbsp;&nbsp;&nbsp;&nbsp;Programados </a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_mant_o_res.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_mant_o_res.php">&nbsp;&nbsp;&nbsp;&nbsp;Resueltos</a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_mant_o_req.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_mant_o_req.php">&nbsp;&nbsp;&nbsp;&nbsp;Requisiciones</a></strong>
				</div>
            </div>
          </div>
        </div>
...
<div class="buscar_index" >	
	...
	$consulta = "SELECT * from sop_preventivo Where ubicacion='Oficinas' AND estado_ticket='Resuelto' ";
	$resultado = mysqli_query( $conexion, $consulta) or die ( "Algo ha ido mal en la consulta a la base de datos");

ECHO "<table class='table table-hover table-striped table-bordered'><th>Acción</th><th>Id</th><th>Fecha</th><th>Serie</th><th>Fecha Programada</th><th>Estado</th><th>Usuario</th><th>Email</th>";
while ($fila = mysqli_fetch_array( $resultado )){
	echo "<tr>";
      ?>
		<td class="text-center">
					<a href="ticketpre_root_edit.php?id=<?php echo $fila['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
				<a href="./lib/<?php echo $fila['ubicacion']; ?>_pdf_prev.php?id=<?php echo $fila['serie']; ?>" class="btn btn-sm btn-warning" target="_blank"><i class="fa fa-print" aria-hidden="true"></i></a>
        </td>
        <?php
		ECHO " <TD>".utf8_decode($fila["id"])."</TD>";
        ECHO " <TD>".utf8_decode($fila["fecha_lev"])."</TD>";
		ECHO " <TD>".utf8_decode($fila["serie"])."</TD>";
        ECHO " <TD>".utf8_decode($fila["fecha"])."</TD>";
		ECHO " <TD>".u-tf8_decode($fila["estado_ticket"])."</TD>";
