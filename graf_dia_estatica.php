...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Caida de Presion Estatica de Filtros'
    },
    subtitle: {
...
//	echo "['".$fila["equipo"]."',".$fila["caida_merv8"]."],";
//			}
		?>
		]
		 },{
		 
        name: 'Carbon Activado (in. Wg.)',
        data: [
		<?php
	...
	echo "['".$rin["equipo"]."',".$rin["caida_merv15"]."],";
			}
		?>
		]
		},{
        ...
        data: [
		<?php
		$consulta3 = "SELECT * FROM diario_serv WHERE equipo = '$equipo'  ORDER by fecha_servicio ";
	...
	echo "['".$rew["equipo"]."',".$rew["caida_merv17"]."],";
		}
		?>		
		]
    }],
