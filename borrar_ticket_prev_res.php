		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Mantenimientos Programados</h1>
		...
		<!--************************************ Page content******************************-->
		 <div class="container">
          <div class="row">
            <div class="col-sm-12">
           <div class="page-header2">
<a class="boton_personalizado" href="ticket_prev_prog.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_prev_prog.php">&nbsp;&nbsp;&nbsp;&nbsp;Programados </a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_prev_res.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_prev_res.php">&nbsp;&nbsp;&nbsp;&nbsp;Resueltos</a></strong>
...
<div class="buscar_index" >	
	...
	$consulta = "SELECT * from sop_preventivo  
	inner join usuario_sop on sop_preventivo.nombre_usuario=usuario_sop.id_usuario
	...
	echo "<tr>";
      ?>
		<td class="text-center">
					<a href="ticketpre_edit2.php?id=<?php echo $fila['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
				<a href="./lib/pdf_prev.php?id=<?php echo $fila['serie']; ?>" class="btn btn-sm btn-warning" target="_blank"><i class="fa fa-print" aria-hidden="true"></i></a>
        </td>
        <?php
