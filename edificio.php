...
<section id="content">	 
  ...
  <table>
		    <a href="add_edificio2.php" ><button type="submit" value="Adicionar" name="" class="btn btn-primary" style="text-align:center"><i class="fa fa-plus"></i>&nbsp;&nbsp;Adicionar</button></a>
			<td>
 <tr>
...
<div class="buscar_index" style="width: 3550px;">	
	...
	$cons = "SELECT * FROM edificio";
	//$consulta = "SELECT edificio.id, edificio.descripcion, edificio.calle, edificio.numero_interior, edificio.numero_exterior,
	//	edificio.colonia, edificio.municipio, edificio.entidad_federativa, edificio.codigo_postal, edificio.pais, edificio.direccion_gps,
	//	edificio.contacto_nombre, edificio.contacto_apellido,edificio.contacto_puesto, edificio.contacto_email, edificio.contacto_telefono;
...
ECHO "<table class='table table-hover table-striped table-bordered'><th 'width:15px'>Acción</th><th>Id</th><th>Empresa</th><th>Descrpción</th>
