...
<section id="content">	 
  ...
  <table>
		    <a href="seccion3_admin.php" ><button type="submit" value="Adicionar" name="" class="btn btn-primary" style="text-align:center"><i class="fa fa-plus"></i>&nbsp;&nbsp;Adicionar</button></a>
			<td>
 <tr>
      <button onClick="document.location.reload();" type="submit" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Click Actualizar Datos" HSPACE="10" VSPACE="10"><i class="fa fa-refresh fa-spin  fa-fw"></i>
		...
		<div class="container">
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Servicios</h1>
		...
		<form style="float: left; height: 35px;" class="busc_dato" method="POST" action="equipo.php" onSubmit="return validarForm(this)"><i class="fa fa-search" aria-hidden="true"></i>
				<input placeholder="Buscar por Equipo o fecha" type="text" id="busqueda" />
...
<div class="buscar_index" style="width: 1500px;">	
    <?php
	$usuario = "veco_dvi";
