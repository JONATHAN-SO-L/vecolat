...
<section id="content">	 
 ...
 <!--/////////////////////////////////////////////////////////--> 
  ...
  <table>
		   <a href="seccion_admin.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center">&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
    ...
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form role="form" action="seccion_consul2_admin.php" method="POST">
