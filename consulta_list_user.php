...
<section id="content">	 
  ...
  <table>
		    <a href="consul_diario_user.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center"></i>&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
...
<script>
  $(document).ready(function(){
    $("button#save").click(function (){
       window.open ("./lib/pdf_dia_user.php?id="+$(this).attr("data-id"));
    });
  });
</script>
<footer></footer>
