		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Eliminar Usuarios</h1>
...
if(isset($_POST['nombre_usuario']) && isset($_POST['nombre_comp'])){
		$id_edit=MysqlQuery::RequestPost('id_edit');
		$descripcion=  MysqlQuery::RequestPost('nombre_usuario');
		$prioridad=  MysqlQuery::RequestPost('nombre_comp');

	if(isset($_POST['nombre_usuario']) && isset($_POST['nombre_comp'])){
          $empresa_delete=MysqlQuery::RequestPost('nombre_usuario');
          $corto_delete=MysqlQuery::RequestPost('nombre_comp');
         
          $sql=Mysql::consulta("SELECT * FROM usuario_sop WHERE nombre_usuario= '$empresa_delete' AND nombre_comp='$corto_delete'");

          if(mysqli_num_rows($sql)>=1){
             MysqlQuery::Eliminar("usuario_sop", "nombre_usuario='$empresa_delete' and nombre_comp='$corto_delete'");
            ...
            echo'
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        No hemos podido eliminar al Usuario por que los datos han sido ocupados por otras bases.
                    </p>
                </div>
            '; 
          }
...
?>
	  ...
	  <fieldset>
                            ...
                            <label class="col-sm-222 control-label">Nombre Usuario</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" readonly="" name="nombre_usuario" maxlength="15" value="<?php echo utf8_decode($reg['nombre_usuario'])?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" type="text" readonly="" name="email_usuario" value="<?php echo utf8_decode($reg['email_usuario'])?>">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" type="text" readonly="" name="ubicacion" value="<?php echo utf8_decode($reg['ubicacion'])?>">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
