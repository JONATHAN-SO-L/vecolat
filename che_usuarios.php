...
<br>
	...
	$consulta = "SELECT * from reg_checador";
	
	$resultado = mysqli_query( $conexion, $consulta ) or die ( "Algo ha ido mal en la consulta a la base de datos");
	
ECHO "<table class='table table-hover table-striped table-bordered'><th>Id</th><th>Nombre Usuario</th><th>Fecha</th><th>Hora Entrada</th><th>Hora Salida</th><th>Sistemas</th>";
while ($fila = mysqli_fetch_array( $resultado )){
	echo "<tr>";
      ?>
		<!--td class="text-center">
                    <a href="edit_usuario.php?id=<?php echo $fila['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
		...
		ECHO " <TD>".utf8_encode($fila["hora_entrada"])."</TD>";
		ECHO " <TD>".utf8_decode($fila["hora_salida"])."</TD>";
		ECHO " <TD>".utf8_decode($fila["sis_func"])."</TD>";
