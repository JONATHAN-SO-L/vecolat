  ...
  if(isset($_POST['empresa_id']) && isset($_POST['area'])){        
		...
		if(isset($_POST['prioridad'])){
			...
			<div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        La Área ha sido guardada exitosamente
                    </p>
                </div>
				';
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Copiar Área</h1>
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" type="text" name="area" maxlength="30" value="<?php echo utf8_decode($reg['area'])?>">
