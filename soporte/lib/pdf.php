...
$pdf->Image('../img/base.png',40,10,-300);
$pdf->Cell (0,5,utf8_decode('Devecchi Ingenieros'),0,1,'C');
$pdf->Cell (0,5,utf8_decode('Reporte de problema mediante Inidencia'),0,1,'C');
...
$pdf->Cell (0,5,utf8_decode('Información de la incidencia #'.utf8_decode($reg['serie'])),0,1,'C');
...
$pdf->Cell (35,10,utf8_decode('Área'),1,0,'C',true);
$pdf->Cell (0,10,utf8_decode($reg['area']),1,1,'L');
//$pdf->Cell (35,10,utf8_decode('Ubicación'),1,0,'C',true);
//$pdf->Cell (0,10,utf8_decode($reg['ubicacion']),1,1,'L');
