...
<div class="container">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, aqui se muestran todos los Tickets de Veco los cuales podra eliminar, modificar e imprimir.</p>
            </div>
          </div>
        </div>
            <?php
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
									...
									<td class="text-center">
                                        ...
                                        <td class="text-center"><?php echo $row['num_equipo']; ?></td>
                                        ...
                                        <!--td class="text-center"><?php// echo utf8_decode($row['area']); ?></td>
                            ...
                            <?php else: ?>
                                <h2 class="text-center">No hay incidencias registradas en el sistema</h2>
                            <?php endif; ?>
                        </div>
                        <?php 
                            if($numeropaginas>=1):
