...
<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        <?php
            if(isset($_POST['id_del'])){
                ...
                if(MysqlQuery::Eliminar("administrador", "id='$id_admin'")){
                    echo '
            ...
            $idA=$_SESSION['id'];
            /* Todos los admins*/
            $num_admin=Mysql::consulta("SELECT * FROM administrador WHERE id!='1' AND id!='$idA'");
...
<div class="container">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, en esta página se muestran todos los usuarios y administradores registrados en Veco, usted podra eliminarlos si lo desea.</p>
            </div>
          </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <?php 
                                ...
                                $seladmin=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM administrador WHERE id!='1' AND id!='$idA' LIMIT $inicio, $regpagina");
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Nombre de Admin</th>
