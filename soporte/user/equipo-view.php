...
<?php
    ...
    if(isset($_POST['user_nomb']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
       ...
       //$clave_reg=md5(MysqlQuery::RequestPost('clave_reg'));
        ...
        if(MysqlQuery::Guardar("usuario_sop", "nombre_usuario, clave, nombre_comp, email_usuario, area, telefono", "'$nombre_reg', '$user_nomb', '$clave_reg', '$email_reg', '$user_area', '$telefono_reg'")){
