...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php"><i class="fa fa-laptop"></i>&nbsp;&nbsp;Veco</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
						...
						<li>
						<a href="./inicio_user.php"><span class="glyphicon fa fa-home"></span> &nbsp; Home</a>
						</li>
                        <li>
            ...
            <ul class=" nav navbar-nav navbar-right">
                <!--li>
                    <a href="./index.php"><span class="glyphicon fa fa-home"></span> &nbsp; Home</a>
                </li-->
				<li>
                    <a href="./index.php?view=soporte"><span class="glyphicon fa fa-cogs"></span> &nbsp; Tickets</a>
                </li>
                <!--li>
