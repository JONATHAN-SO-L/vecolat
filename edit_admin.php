          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Editar Administrador</h1>
...
if(isset($_POST['nombre_admin']) && isset($_POST['nombre'])){
	...
	if(MysqlQuery::Actualizar("administrador", "nombre_admin='$nombre_admin', clave='$clave2', nombre='$nombre', apellido='$apellido', email_admin='$email_admin', telefono='$telefono'", "id='$id_edit'")){
	...
	include ("conexi.php");
	 ...
	 if(isset($_POST['nombre_admin']) && isset($_POST['nombre'])){ 
		...
		if(isset($_POST['telefono'])){
			...
			if(mysqli_query($con,("UPDATE administrador set nombre_admin='$nombre_admin', clave='$clave2', nombre='$nombre', apellido='$apellido', email_admin='$email_admin', telefono='$telefono' WHERE id='$id_edit'"))){
		*/
	  ...
	  <fieldset>
					 <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" placeholder="Nombre de Administrador" type="text" name="nombre_admin" value="<?php echo utf8_encode($reg['nombre_admin'])?>">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" type="email" placeholder="Escriba su Correo" name="email_admin" value="<?php echo utf8_encode($reg['email_admin'])?>">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
