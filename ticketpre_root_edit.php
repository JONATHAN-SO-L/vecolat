...
//if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){
    ...
    $requisiciones=  MysqlQuery::RequestPost('requisiciones');
		...
		Saludos Cordiales\r\n �0�9rea de sistemas \r\n sistemas@veco.mx \r\n \r\n 
        Por favor, NO responda a este mensaje, es un env��o autom��tico";
		...
		if(MysqlQuery::Actualizar("sop_preventivo", "estado_ticket='$estado_edit', observaciones='$solucion_edit', fecha_mant='$fecha_mant', requisiciones='$requisiciones'", "id='$id_edit'")){
...
<title>Editar Preventivo</title>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Actualizacion</h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-9">
                <a href="javascript:history.back(1)" class="btn btn-primary btn-sm pull-right"><i class="fa fa-reply"></i>&nbsp;&nbsp;Volver</a>
            </div>
          </div>
        </div>
                ...
                <form class="form-horizontal" role="form" action="" method="POST">
						...
						<div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                  <input type="text" readonly="" class="form-control"  name="usuario" readonly="" value="<?php echo $reg['usuario']?>">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" rows="3"  name="mantenimiento" readonly="" required=""><?php echo $reg['seguimiento']?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                  <label  class="col-sm-2 control-label">Requisiciones</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="3" placeholder="Sin requisiciones" name="requisiciones" id="requisiciones"><?php echo utf8_decode($reg['requisiciones'])?></textarea>
                </div>
            </div>
                            ...
                            <div class="col-sm-offset-5">
								...
								<div class="radio">
                                    <label>
                                        <input type="radio" name="optionsRadios" value="option2" checked>
                                         Enviar email de solucion del mantenieminto al usuario
                                    </label>
                                 </div>
                                ...
                                <div class="radio">
                                    <label>
                                        ...
                                        No enviar email de solucion del mantenieminto al usuario
                                    </label>
                                 </div>
