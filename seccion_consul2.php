...
<section id="content">	 
  ...
  <table>
		    <a href="seccion0.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center"></i>&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
	...
	echo "<tr>";
      ?>
		<td class="text-center">
			...
			<!--a href="seccion_consul.php?id=<?php echo $fila['id_servicio']; ?>" class="btn btn-info"><i class="fa fa-eye" aria-hidden="true"></i></a-->
		</td>
        <?php
