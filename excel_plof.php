...
if (isset($_POST['generar_reporte'])) {
	...
	$query = "SELECT * FROM ticket WHERE fecha_2 BETWEEN '$fecha1' AND '$fecha2' AND (estado_ticket= 'En proceso' OR estado_ticket = 'Reparacion en garantia' OR estado_ticket = 'Requisicion de compra' OR estado_ticket = 'Resuelto' OR estado_ticket = 'Cancelado' OR estado_ticket = 'Resuelto compra')";
}?>
...
?>
	...
	$inicio2022 = "SELECT * FROM ticket WHERE fecha_2 BETWEEN '2021-01-01' AND '2022-06-30' AND (estado_ticket= 'Pendiente' OR estado_ticket= 'En proceso' OR estado_ticket = 'Reparacion en garantia' OR estado_ticket = 'Requisicion de compra')";
