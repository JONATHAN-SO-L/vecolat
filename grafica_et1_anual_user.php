...
<section id="content">
 ...
 <table>  
    <td>
		<tr>
       <a href="grafica_anual_user.php" ><button  type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center"><i class="fa fa-reply"></i>&nbsp;&nbsp;Regresar</button></a>
	   </tr>
	   <tr>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Consultar Grafica 1era Etapa</h1>
    ...
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form role="form" target="_blank"  action="grafica_et1_anual2.php" method="POST">
			...
			<div><label><i class="fa fa-hospital-o"></i>&nbsp;Equipo</label>
				...
				<?php } ?>
						...
						<div class="form-group">
                            <label  class="col-sm-222 control-label">A&#241;o</label>
