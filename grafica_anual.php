...
<a class="button" href="grafica_et1_anual.php" style="width: 234px;margin-left: 40px;">
...
<td>
						<tr>
						    <div class="col-lg-3 col-xs-6">
<a class="button" href="grafica_et2_anual.php" style="width: 234px;margin-left: 40px;">
 ...
 <table>
				<div class="col-lg-3 col-xs-6">
<a class="button" href="grafica_et3_anual.php" style="width: 234px;margin-left: 40px;">
...
<td>
						<tr>
						    <div class="col-lg-3 col-xs-6">
<a class="button" href="grafica_et4_anual.php" style="width: 234px;margin-left: 40px;">
...
<table>
				<div class="col-lg-3 col-xs-6">
<a class="button" href="grafica_uptime.php" style="width: 234px;margin-left: 40px;">
...
<td>
						<tr>
						    <div class="col-lg-3 col-xs-6">
<a class="button" href="grafica_moto_anual.php" style="width: 234px;margin-left: 40px;">
