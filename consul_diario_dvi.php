...
<section id="content">	 
 ...
 <!--/////////////////////////////////////////////////////////--> 
  ...
  <table>
		   <a href="diario_servic_dvi.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center">&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
		...
		<div class="container" style="width:1180px;">
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Consultar Servicio Diario</h1>
    ...
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form role="form" action="consul_dia_list_dvi.php" method="POST" enctype="multipart/form-data">
