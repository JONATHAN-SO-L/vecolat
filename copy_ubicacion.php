...
<header id="main-header">
 ...
 <!--/////////////////////////////////////////////////////////-->
  ...
  if(isset($_POST['empresa_id']) && isset($_POST['ubicacion'])){        
		...
		if(isset($_POST['requisitos_acceso'])){
			...
			if(mysqli_query($con,("INSERT INTO ubicacion(empresa_id, edificio_id, ubicacion, requisitos_acc)VALUES('$empresa_id','$edificio_id','$descripcion','$requisitos_acceso')"))){
			
            echo '
			<div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    <a href="ubicacion.php" class="alert-link"><span aria-hidden="true">Cerrar</span></a>
                    <h4 class="text-center">Ubicación GUARDADO</h4>
                    <p class="text-center">
            ...
            echo '
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        No hemos podido guardar La Ubicación. Por favor intente nuevamente.
                    </p>
                </div>
            ';
          }
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Copiar Ubicación</h1>
      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
			<form role="form" action="" method="POST">
						...
						<input type="hidden" readonly="" name="id_edit" readonly="" value="<?php echo $reg['id_ubicacion']?>">
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" type="text" placeholder="Descripción" name="ubicacion" maxlength="30" value="<?php echo utf8_decode($reg['ubicacion'])?>">
						 ...
						 <div class="form-group">
                          ...
                          <div class="col-sm-10" style="padding-left: 1px;">
                            <textarea style="width: 717px;" class="form-control" rows="1"  name="requisitos_acceso" required=""><?php echo utf8_decode($reg['requisitos_acc'])?></textarea>
                           </div>
                          </div>
                        </div>
						</div>
