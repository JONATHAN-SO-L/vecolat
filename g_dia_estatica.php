          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Consultar Grafica Caida de Presion Estatica de Filtros</h1>
    ...
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form role="form" target="_blank"  action="graf_dia_estatica.php" method="POST">
