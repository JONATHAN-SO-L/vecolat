      ...
      <div class="row">
        <div class="col-sm-12">
         <div class="page-header2">
          ...
          <h1 class="animated lightSpeedIn">Requisiciones de Mantenimientos en Oficinas</h1>
  ...
  <div class="row">
    <div class="col-sm-12">
     <div class="page-header2">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a class="boton_personalizado" href="ticket_mant_p_req.php"><i class="fa fa-file-text"></i></a><strong><a href="ticket_mant_o_req.php">&nbsp;&nbsp;&nbsp;&nbsp;Requisiciones</a></strong>
    </div>
  </div>
</div>
</div><br>
...
if (isset($_POST['fechas'])) {
  ...
  $consulta = "SELECT * from sop_preventivo Where ubicacion='Oficinas' AND fecha BETWEEN '$fecha1' AND '$fecha2' AND requisiciones != '' ORDER BY fecha DESC ";
...
<table>
 ...
 <div class="buscar_index" >	
  ...
  $consulta = "SELECT * from sop_preventivo Where ubicacion='Oficinas' AND estado_ticket='Resuelto' AND requisiciones != '' ORDER BY fecha DESC ";
  $resultado = mysqli_query( $conexion, $consulta) or die ( "Algo ha ido mal en la consulta a la base de datos");
