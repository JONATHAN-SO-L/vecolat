...
<a class="button" href="diario_crear_dvi.php" style="width: 234px;margin-left: 40px;">
	<center>Crear</center>
	<div class="button__horizontal"></div>
	<div class="button__vertical"></div>
</a>
<br>
<a class="button" href="consul_diario_dvi.php" style="width: 234px;margin-left: 40px;">
	<center>Consultar</center>
	<div class="button__horizontal"></div>
	<div class="button__vertical"></div>
</a>
<br>
<a class="button" href="consul_dia_dvi.php" style="width: 234px;margin-left: 40px;">
	<center>Consultar PDF Diario</center>
	<div class="button__horizontal"></div>
	<div class="button__vertical"></div>
</a>
<br>
<a class="button" href="grafica_diario_dvi.php" style="width: 234px;margin-left: 40px;">
