		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Mantenimientos Programados Planta</h1>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_mant_oficina.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_mant_oficina.php">&nbsp;&nbsp;&nbsp;&nbsp;Oficina</a></strong>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
           <div class="page-header2">
<a class="boton_personalizado" href="ticket_mant_p_prog.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_mant_o_prog.php">&nbsp;&nbsp;&nbsp;&nbsp;Programados </a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="boton_personalizado" href="ticket_root_p_res.php"><i class="fa fa-pencil"></i></a><strong><a href="ticket_root_o_res.php">&nbsp;&nbsp;&nbsp;&nbsp;Resueltos</a></strong>
				</div>
            </div>
          </div>
        </div>
...
<div class="buscar_index" >	
	...
	$consulta = "SELECT * from sop_preventivo Where ubicacion='Planta' ";
