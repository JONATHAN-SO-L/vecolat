...
<a class="button" href="consul_grafxetapa_dvi.php" style="width: 234px;margin-left: 40px;">
...
<td>
						<tr>
						    <div class="col-lg-3 col-xs-6">
<a class="button" href="consul_grafxetapa2_dvi.php" style="width: 234px;margin-left: 40px;">
 ...
 <table>
				<div class="col-lg-3 col-xs-6">
<a class="button" href="consul_grafxetapa3_dvi.php" style="width: 234px;margin-left: 40px;">
...
<td>
						<tr>
						    <div class="col-lg-3 col-xs-6">
<a class="button" href="consul_grafxetapa4_dvi.php" style="width: 234px;margin-left: 40px;">
...
<table>
				<div class="col-lg-3 col-xs-6">
<a class="button" href="consul_grafica_dvi.php" style="width: 234px;margin-left: 40px;">
...
<td>
						<tr>
						    <div class="col-lg-3 col-xs-6">
<a class="button" href="consul_moto_dvi.php" style="width: 234px;margin-left: 40px;">
