          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Borrar Servicio </h1>
...
if(isset($_POST['equipo']) && isset($_POST['id_servicio']) && isset($_POST['fecha_servicio'])){
		$id_servicio=MysqlQuery::RequestPost('id_servicio');
	...
	if(isset($_POST['equipo']) && isset($_POST['equipo'])){
          ...
          $sql=Mysql::consulta("SELECT * FROM servicio2 WHERE equipo= '$empresa_delete'");

          if(mysqli_num_rows($sql)>=1){
             MysqlQuery::Eliminar("servicio2", "equipo='$empresa_delete' and fecha_servicio='$corto_delete' and carpeta='$carpeta'");
            ...
            echo'
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    <a href="tabla_servicios.php"><button type="button" class="close"  data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                            ...
                            <label class="col-sm-222 control-label">Id</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" readonly="" name="id_servicio" readonly=""  value="<?php echo $registro['id_servicio']?>">
