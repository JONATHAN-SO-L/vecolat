          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Ver Ubicación </h1>
...
$id = MysqlQuery::RequestGet('id');
	$sql = Mysql::consulta("SELECT * FROM ubicacion inner join empresas on ubicacion.empresa_id=empresas.id
                            ...
                            <label class="col-sm-222 control-label">Id</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" readonly="" name="id_edit" readonly=""  value="<?php echo $reg['id_ubicacion']?>">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
                          ...
                          <div class="col-sm-10" style="padding-left: 1px;">
                            <textarea style="width: 717px;" readonly="" class="form-control" rows="1"  name="requisitos_acceso" required=""><?php echo utf8_decode($reg['requisitos_acc'])?></textarea>
                           </div>
                          </div>
                        </div>
						</div>
