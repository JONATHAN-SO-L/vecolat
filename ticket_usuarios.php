...
<section id="content">	 
  ...
  <table>
		    <a href="ticket_add_us.php" ><button type="submit" value="Adicionar" name="" class="btn btn-primary" style="text-align:center"><i class="fa fa-plus"></i>&nbsp;&nbsp;Adicionar</button></a>
			<td>
 <tr>
		...
		<div class="container" >
          <div class="row">
           ...
           <div class="page-header2">
                ...
                <h1 class="animated lightSpeedIn">Administracion de Usuarios</h1>
...
<div class="buscar_index">	
	...
	$consulta = "SELECT * from usuario_sop ";
	$resultado = mysqli_query( $conexion, $consulta) or die ( "Algo ha ido mal en la consulta a la base de datos");



ECHO "<table class='table table-hover table-striped table-bordered'><th>Acciones</th><th>ID</th><th>Usuario</th><th>Clave</th><th>Nombre completo</th><th>Email</th><th>Area</th><th>Ip</th>";
while ($fila = mysqli_fetch_array( $resultado )){
	echo "<tr>";
      ?>
		<td class="text-center">
					<a href="ticket_usuario_edit.php?id=<?php echo $fila['id_usuario']; ?>" class="btn btn-sm btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
					<a href="ticket_usuario_eli.php?id=<?php echo $fila['id_usuario']; ?>"class="btn btn-sm btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
        </td>
        <?php
		...
		ECHO " <TD>".utf8_decode($fila["telefono"])."</TD>";
