          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Adicionar Administrador</h1>
...
<?php
 ...
 if(isset($_POST['nombre_admin']) && isset($_POST['clave'])){        
		...
		if(isset($_POST['telefono'])){
			...
			if(mysqli_query($con,("INSERT INTO administrador( nombre_admin, clave, nombre, apellido, email_admin, telefono)VALUES('$nombre_admin','$clave2','$nombre', '$apellido', '$email_admin','$telefono')"))){
			
            echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    <a href="tabla_admin.php" class="alert-link"><span aria-hidden="true">Cerrar</span></a>
      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form role="form" action="" method="POST">
              ...
              <input type="text" id="input_user" class="form-control" name="nombre_admin" placeholder="Nombre de usuario" required=""  maxlength="10">
              <div id="com_form"></div>
            </div>
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" placeholder="Nombre de Administrador" type="text" name="nombre" maxlength="30">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" placeholder="Apellido de Administrador" type="text" name="apellido" maxlength="30">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" type="email" placeholder="Email" name="email_admin" maxlength="100">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" placeholder="Telefono" type="text" name="telefono" maxlength="50">
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
