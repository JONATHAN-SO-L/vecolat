...
<section id="content">	 
  ...
  <table>
		    <a href="diario_crear_dvi.php" ><button type="submit" value="Regresar" name="" class="btn btn-primary" style="text-align:center">&nbsp;&nbsp;Regresar</button></a>
			<td>
 <tr>
    ...
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form  method="POST" action="serv_dba_dvi.php"  enctype="multipart/form-data">
						...
						<input type="hidden" readonly="" name="semana" readonly="" value="<?php echo date("W");?>">
						<input type="hidden" readonly="" name="dia" readonly="" value="<?php echo date("l");?>">
