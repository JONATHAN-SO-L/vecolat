          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Adicionar Ubicación</h1>
        ...
        <div class="panel-body">
			...
			<!--/////////////////////////////////////////////////////////////////////////////////////////////////////-->
						...
						<div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" required="" type="text" placeholder="Descripción" name="ubicacion" maxlength="30">
						...
						<div class="form-group">
                          ...
                          <div class="col-sm-110">
						  <div class='input-group'>
                            <textarea class="text" style="width: 717px;" class="form-control" rows="2"  name="requisitos_acceso" ></textarea>
                          </div>
						  </div>
                        </div>			
